...
/**
 * Migration 001 — CP-2 RT-001 / RT-013 / RT-015 foundation.
 *
 * Creates:
 *   - tenants            (minimal stub, expanded in RT-013 work)
 *   - raw_intake         (DB-001)
 *   - intake_meta        (DB-002)
 *   - idempotency_keys   (RT-015)
 *
 * Enables RLS with `app.tenant_id` GUC pattern per docs/MendoraCI_DataModelERD.md §6.
 */
